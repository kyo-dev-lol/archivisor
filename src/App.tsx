    ...
    <>
      ...
      {state.phase === 'idle' && (
        <DropZone
          ...
          onCreateArchive={() => setState({ phase: 'pack' })}
        />
      )}
      {state.phase === 'pack' && <PackZone onBack={() => setState({ phase: 'idle', error: null })} />}
    ...
    <div className="flex min-h-[100dvh] flex-col items-center justify-center px-6 text-center">
      <div className="max-w-md animate-rise">
        ...
        <p className="mt-3 text-xs text-[var(--vault-ink-faint)]">
          This format isn't supported for in-browser parsing yet. Try ZIP, 7Z, TAR, TAR.GZ, GZ, BZ2 or
          XZ.
        </p>
        <button
          type="button"
